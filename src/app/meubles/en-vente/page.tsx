...
const DESCRIPTION =
  "Découvrez nos meubles anciens restaurés et disponibles à la vente : des pièces uniques poncées, peintes et cirées à la main.";

export const metadata = creerMetadataPage({
  titre: "Nos meubles en vente — Atelier Petita",
  description: DESCRIPTION,
  chemin: "/meubles/en-vente",
});
    ...
    <div className="overflow-x-hidden">
      <JsonLd
        data={grapheSchema(
          filArianeJsonLd([
            { nom: "Accueil", chemin: "/" },
            { nom: "Nos meubles en vente", chemin: "/meubles/en-vente" },
          ]),
